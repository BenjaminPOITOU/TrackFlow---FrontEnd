...
export function CompositionList({ compositions, projectId, onCompositionDeleted, onCompositionUpdated }) {
  ...
  <div className="w-full">
    {compositions.length > 0 ? (
        ...
        <table className="w-full border-collapse">
          <thead className="hidden sm:table-header-group">
            <tr className="border-b border-gray-700">
              <th className="text-left p-3 text-[0.875rem] font-medium text-gray-300">Composition</th>
              <th className="text-center p-3 text-[0.875rem] font-medium text-gray-300">Versions</th>
              <th className="text-center p-3 text-[0.875rem] font-medium text-gray-300">Branches</th>
              <th className="text-center p-3 text-[0.875rem] font-medium text-gray-300">Statut</th>
              <th className="text-center p-3 text-[0.875rem] font-medium text-gray-300">Date</th>
              <th className="text-center p-3 text-[0.875rem] font-medium text-gray-300">Actions</th>
            </tr>
          </thead>
          <tbody>
      ...
      <p className="text-[0.875rem] text-gray-500 p-4 text-center">Aucune composition trouvée.</p>
    )}
  </div>
</div>
  );
